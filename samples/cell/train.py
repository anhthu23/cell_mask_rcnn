...
class CustomConfig(Config):
    """Configuration for training on the blood cells dataset.
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "erythrocyte")
        self.add_class("object", 2, "leucocyte")
        ...
        for value in annotations :
            print(value)
            # annotations.append(value.values())
        ...
        for a in annotations:
            ...
            #print([a['regions'][r]['shape_attributes'] for r in a['regions']])
            #polygons = [r['shape_attributes'] for r in a['regions']]
            #objects = [s['region_attributes']['objects'] for s in a['regions']]
            polygons = [a['regions'][r]['shape_attributes'] for r in a['regions']]
            objects = [a['regions'][r]['region_attributes']['label'].strip() for r in a['regions']]
            print("objects:",objects)
            name_dict = {"Erythrocyte": 1,"Leucocyte": 2}
            # key = tuple(name_dict)
    ...
    def load_custom_for_detect(self, dataset_dir):
        ...
        allFiles = [f for f in os.listdir(os.path.join(dataset_dir)) if os.path.isfile(os.path.join(dataset_dir, f))]
...
def train(model):
    ...
    model.train(dataset_train, dataset_val,
                ...
                epochs=50,  #This value can be changed
                layers='heads')
